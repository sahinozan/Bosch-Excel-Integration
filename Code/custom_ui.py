...
class App(CTk):
    ...
    def __init__(self) -> None:
        ...
        self.appearance_mode_option_menu.grid(row=6, column=0, padx=20, pady=(10, 20))
        self.create_labels()
    ...
    def create_buttons(self) -> tuple[CTkButton, CTkButton, CTkButton, CTkButton]:
        ...
        transform_button = CTkButton(self.sidebar_frame, command=self.destroy,
                                     text="Transform")
        return next_week_button, current_week_button, output_destination_button, transform_button
